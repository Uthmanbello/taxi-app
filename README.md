...
# 📖 [Lyft App] <a name="about-project"></a>

**[Lyft App]** is an app that allows users to book rides and rate their experience with the company during the trip
...
- [Live Demo Link](https://uthmanbello.github.io/taxi-app/)
...
`git clone https://github.com/Uthmanbello/taxi-app`<br>
`cd taxi-app`<br>
...
- Add a more interactive Google Map on the homepage
- Setup the submit button on the ratings page
...
Feel free to check the [issues page](https://github.com/Uthmanbello/taxi-app/issues/).
...
I would like to thank Boluwatife Olla and the Swiphr team for giving me this opportunity to showcase my mobile app development skills

<p align="right">(<a href="#readme-top">back to top</a>)</p>

## 📝 License <a name="license"></a>

This project is [MIT](https://github.com/Uthmanbello/taxi-app/blob/dev/LICENSE) licensed.
